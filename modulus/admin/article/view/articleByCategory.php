    ...
    <div class="table_content">
        ...
        <section id="paginator">
            <div class="paginator_box">
                <a href="/panel/article/category/<?php echo $category->section_slug; ?>/<?php echo $category->category_slug; ?>/page/1">НАЧАЛО</a>
                <?php \library\pagination::selector($data->page, "panel/article/category/{$category->section_slug}/{$category->category_slug}/"); ?>
                <a href="/panel/article/category/<?php echo $category->section_slug; ?>/<?php echo $category->category_slug; ?>/page/<?php echo $data->page->length ? $data->page->length : 1; ?>">КОНЕЦ</a>
            </div>
        </section>
        <!-- paginator -->
    </div>
