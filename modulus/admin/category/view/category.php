    ...
    <div class="table_content">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td aria-label='update'>
                        <a data-load="/panel/category/update/<?php echo $category->category_id; ?>" class="load_btn" data-id="<?php echo $category->category_id; ?>">
                            <img src="<?php echo SVG1; ?>update.svg">
                        </a>
                    </td>
                   ...
                   <td aria-label='category'>
                    ...
                    <td aria-label='sub title'><?php echo $category->category_subtitle; ?></td>
        ...
        <section id="paginator">
            <div class="paginator_box">
                <a href="/panel/category/page/1">НАЧАЛО</a>
                <?php \library\pagination::selector($data->page, 'panel/category/'); ?>
                <a href="/panel/category/page/<?php echo $data->page->length ? $data->page->length : 1; ?>">КОНЕЦ</a>
           </div>
        </section>
        <!-- paginator -->
    </div>
