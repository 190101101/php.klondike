    ...
    <div class="table_content">
        ...
        <section id="paginator">
            <div class="paginator_box">
                <a href="/panel/post/notice/<?php echo $notice->notice; ?>/page/1">НАЧАЛО</a>
                    <?php \library\pagination::selector($data->page, "panel/post/notice/{$notice->notice}/"); ?>
                <a href="/panel/post/notice/<?php echo $notice->notice; ?>/page/<?php echo $data->page->length ? $data->page->length : 1; ?>">КОНЕЦ</a>
            </div>
        </section>
        <!-- paginator -->
    </div>
