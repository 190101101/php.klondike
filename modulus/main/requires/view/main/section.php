...
<section class="section-sidebar">
    ...
    <div class="cat" id="section-category">
        <?php foreach($sections as $section): ?>
        <ul class="cat-btn-ul">
            <li class="cat-btn-li" data-toggle="collapse" data-target="#section-<?php echo $section->section; ?>">
            ...
            <div id="section-<?php echo $section->section; ?>" class="collapse" aria-labelledby="headingone" data-parent="#section-category">
                 ...
                 <div class="chat-container">
                    ...
                    <div class="chat-container-box">
                        <div class="chat-container-box-inner">
                            ...
                            <span><?php echo $message->chat_date; ?></span>
                        </div>
    ...
    <div id="sidewrappernotice">
        <?php foreach($notices as $notice): ?>
        <div class="notice" id="notice">
            <div class="card">
                <div class="card-header" id="noticesectionone">
                ...
                <div class="notice-card-body" aria-labelledby="noticesectionone" data-parent="#notice">
                    <div class="card-body">
                        <div class="wrap_post">
    ...
    <?php endif; ?>
    <img src="<?php echo GIF; ?>/cote.gif" class="cote" title="meow :) hello i am Cookie">
</section>
